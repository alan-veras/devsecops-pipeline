...
>
> **Status: `building`, phase 1/4 done** · see [docs/PLAN.md](docs/PLAN.md) (pt-BR working document)
...
| Defenses off (control group) |(nenhum)| all pass |
...
- [x] Phase 1, Scaffold + CI gates green
